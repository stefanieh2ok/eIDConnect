...
async function main() {
  ...
  if (home.status !== 200) {
    ...
    console.log('✅ GET / → 200');
    if (!home.text.includes('eIDConnect') && !home.text.includes('eID Demo Connect') && !home.text.includes('eidconnect')) {
      console.log('   ⚠ Kein erkennbares eID-Demo-Branding im HTML gefunden');
    }
  }

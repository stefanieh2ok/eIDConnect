...
export function regionalPraemienForCity(cityName: string) {
  ...
  return [
    ...
    { id: 'rp4', name: `VHS / Weiterbildung ${c} – Kursgutschein`, points: 5000, emoji: '🎓', description: 'Ein Kurs nach Wahl' },
    { id: 'rp5', name: `Stadtfest / Markt ${c} – VIP-Bereich`, points: 3000, emoji: '🎉', description: 'Exklusiver Zugang' },
    { id: 'rp6', name: `ÖPNV-Partner-Region ${c} – Monatsticket`, points: 7000, emoji: '🚌', description: 'ÖPNV im Nahverkehrsverbund' },
  ];
}

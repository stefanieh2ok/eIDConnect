...
import { NdaGateAcceptPanel } from '@/components/access/nda-gate-accept-panel';
...
export default async function AccessPage({ params }: AccessPageProps) {
  ...
  const requireDocusign = tokenRecord.require_docusign !== false;
        ...
        <div className="mx-auto w-full max-w-[360px] min-w-0 space-y-4 pb-6 text-neutral-950">
          <div className="card-section min-w-0 overflow-x-hidden">
            ...
            <div className="card-content mt-4">
              <p className="t-card-title">Empfänger</p>
              <div className="mt-2 space-y-1">
                <p>
                  <span className="t-meta font-semibold text-neutral-900">Name:</span>{' '}
          ...
          <NdaGateAcceptPanel
            token={token}
            requireDocusign={requireDocusign}
            summaryItems={ndaConfig.gateSummary}
          ...
          <section className="card-content nda-gate-secondary">
            <h2 className="t-h2">NDA-Dokument</h2>
            <p className="t-body-sm mt-1 text-neutral-700">
              Optional zum Archivieren, Prüfen oder Ausdrucken — nicht Voraussetzung für die Zustimmung oben.
            </p>
            <div className="mt-3 grid grid-cols-1 gap-2">
              ...
              >
                NDA PDF herunterladen
              </a>
              <a
                href={ndaInlineUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="btn-ghost t-button inline-flex items-center justify-center"
              >
                PDF drucken
              </a>
            </div>
          ...
          <section className="card-content">
            <h2 className="t-h2">Ausführliche Kurzfassung</h2>
            ...
            <p className="t-caption mt-4">{ndaConfig.footer}</p>
          </section>
        </div>
      </div>
    </IphoneFrame>
